...
$(VALGRIND_SUPP):
	...
	@echo "" >> $@
	@echo "{" >> $@
	@echo "   leak_any_external_binary" >> $@
	@echo "   Memcheck:Leak" >> $@
	@echo "   ..." >> $@
	@echo "   obj:/usr/*" >> $@
	@echo "}" >> $@
	@echo "minishell.supp create"
